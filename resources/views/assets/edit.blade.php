                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('assets.update', $asset) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="ticker" class="block mt-1 w-full uppercase" type="text" name="ticker" :value="old('ticker', $asset->ticker)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <select name="type" id="type" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                <option value="stock" @selected(old('type', $asset->type) == 'stock')>Ação (Stock)</option>
                                <option value="fii" @selected(old('type', $asset->type) == 'fii')>Fundo Imobiliário (FII)</option>
                                <option value="crypto" @selected(old('type', $asset->type) == 'crypto')>Criptomoeda</option>
                                <option value="fixed_income" @selected(old('type', $asset->type) == 'fixed_income')>Renda Fixa</option>
